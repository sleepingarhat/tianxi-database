...
**Overall:** 🔴 `critical`  ·  critical gaps: **1**  ·  warn gaps: 19
...
|---|---|---|---|---|---|---|
| race_artefacts | 🟢 ok | 730 | 730 | 0 | 0 |  |
| fixtures_cache | 🟢 ok | 1 | 231 | 0 | 0 | total cached race days: 231 |
| horse_profiles | 🟡 warn | 1201 | 1201 | 0 | 12 | 12 profiles are stale (profile_last_scraped < last_race_date); total profiles in DB: 6068 |
| horse_form_records | 🟢 ok | 1201 | 1201 | 0 | 0 | total form_records files: 6068 |
...
| trial_results | 🟢 ok | 1 | 1 | 0 | 0 | trial rows: 8515 |
