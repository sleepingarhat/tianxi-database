...
**Overall:** 🟡 `warn`  ·  critical gaps: **0**  ·  warn gaps: 14
...
| horse_profiles | 🟡 warn | 1284 | 1284 | 0 | 7 | 7 profiles are stale (profile_last_scraped < last_race_date); total profiles in DB: 6024 |
